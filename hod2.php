<?php
@session_start();
if(!empty($_SESSION['user']) && !empty($_SESSION['priv'])&& $_SESSION['priv']="hod" && ($_SESSION['user']=="admin" || strtolower($_SESSION['user'])=="administrator")){
 $fac = $_SESSION['user'];
...
<div class= "container-fluid">
  ...
  <div class="panel-body">
	   ...
	   <form class="form-signin" role="form" action="comments.php" method="post">
    ...
    <br/><br /><b>Select Faculty Name :</b> &emsp;&emsp;<select name="fname" id="fac" required>
					<option value="">--Select--</option>
        <?php
