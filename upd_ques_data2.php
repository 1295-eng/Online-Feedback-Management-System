...
$k = 0;
 	require('cgs.php');
  	$cgs_obj = new CGS;
		...
		$res1 = $cgs_obj->getEachFdetails("Sri. T. Manohar","22","I","II","15","D","Adaptive Control (AC) ");
		...
		if($res1['jval']==2){
			...
			echo $res1['sid'][0]." = ".$res1['count'][0] ." /-/ ".$res1['sid'][1]." = ".$res1['count'][1];
			echo "<br><br>";
			if(!empty($sub) && $ct>0 && $avg>0){
				$res2 = $cgs_obj->updateErrData("Dr.B.Omprakash","31","I","II","15","D",$sub,$q1,$q2,$q3,$q4,$q5,$q6,$q7,$q8,$q9,$q10,$q11,$q12,$q13,$q14,$avg,$ct);
				echo ++$k." | ".$res2;
				if($res2==0){
					echo 'Check this';
				}
